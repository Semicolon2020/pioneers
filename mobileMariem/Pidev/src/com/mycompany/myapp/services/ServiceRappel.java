...
public class ServiceRappel {
    ...
    public static ServiceRappel instance=null;
    ...
    public static ServiceRappel getInstance() {
        if (instance == null) {
            instance = new ServiceRappel();
        }
        return instance;
    }

    public boolean addRappel(Rappels t) {
        String url = Statics.BASE_URL+"/rappel/add"  + "/" + t.getText()+ "/" + t.getObjet()+ "/" + t.getEnfant(); 
        req.setUrl(url);
