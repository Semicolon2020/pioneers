...
private int id ;
    ...
    private void ajouter(ActionEvent event) {
        try {
            ...
            activite a = new activite(nomA, niveauA, typeA, lieuA, descriptionA);
            sA.ajouter1(a);
    ...
    private void modifier(ActionEvent event) {
        try {
            ...
            activite a = new activite(nomA, niveauA, typeA, lieuA, descriptionA,id);
            sA.update(a);
                ...
                final TableCell<activite, Void> cell = new TableCell<activite, Void>() {
...

                    {
                        btn.setOnAction((ActionEvent event) -> {
                            ...
                            activite AF = Table.getSelectionModel().getSelectedItem();
                            id=AF.getId_ac();
