...
public class InscriptionParentController implements Initializable {
    ...
    @FXML
    private ImageView btnvaliderImg;
    @FXML
    private ImageView photobtnimg;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btnvaliderImg.setImage(new Image("/Image/validerBois.png"));
        photobtnimg.setImage(new Image("/Image/photboisbtn-8.png"));
    ...
    @FXML
    private void retourClicked(MouseEvent event) {
    ...
    @FXML
    private void btnvaliderImgAction(MouseEvent event) {
    ...
    @FXML
    private void photobtnimg(MouseEvent event) {
