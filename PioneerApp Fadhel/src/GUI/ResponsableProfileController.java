 ...
 * @author Alfa Shel
 */
public class ResponsableProfileController implements Initializable {
    ...
    private void validerAction(MouseEvent event) {
          ...
          if( comboetat.getValue()==null || comboxSex.getValue()==null || prenomTextField.equals("")|| pdp.getImage() ==null || mdpTextField.equals("") || mailTextField.equals("") || tlfTextField.equals("")  )
        {
         ...
         {      // public Responsable(String cin, String nom, String prenom, String email,String sexe, String password, String num_tel,String etat_civil) {
             ...
             Responsable r= new Responsable(cinTextField.getText(), nomTextField.getText(), prenomTextField.getText(), mailTextField.getText() , comboxSex.getValue(), mdpTextField.getText(), tlfTextField.getText(), comboetat.getValue(),photopath);
             ServiceResponsable  se=new ServiceResponsable();
