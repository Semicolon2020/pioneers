...
import MahdiService.ServiceEvaluation;
...
public class StatistiquesController implements Initializable {
         ...
         tfActivite.getSelectionModel().selectedIndexProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
                ...
                try {
                    ...
                    i= ser.readAllA(list.get(newValue.intValue()),cin);
    ...
    private void afficher(ActionEvent event) {
        try {
            ...
            Parent p = new Parent();
            p.setCin(cin);
            ObservableList<Evaluation> list = ser.readAllV3(p);
