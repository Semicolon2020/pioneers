 ...
 */
	 ...
	 * @return Marker
	 */
	public Marker generateMarker(LatLng pos,String title)
	{
		Marker marker=null;
	...
	public Mapa(String pString) {
		...
		System.out.print("Wait until it load ");
		try {
			for(int i=0;i<10;i++)
			{
	...
	public static void main(String[] args) throws MalformedURLException, IOException {
            ...
            final Mapa example = new Mapa("ton trajet");
		//example.generateMarker(new LatLng(Double.valueOf(longi),Double.valueOf(lalti)), "okok");
                example.generateMarker(map.getCenter(),"ok");
              
		//example.generateMarker(map.getCenter(),"hh");
              //  example.generateMarker(new LatLng(34.80102,10.18102), "okok");
                
        /*   URL url = new URL("https://api.opencagedata.com/geocode/v1/json?q=rue%2013%20aout%20manouba&key=298b7f9be7d54d9ab21c3e365567b3f0&language=en&pretty=1");
