...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('LcI4PFlnju', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'pionnersapp', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => [], 'defaultTableOptions' => []], $a, $c, []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\PioneerBundle\\Entity'), 1 => ($this->targetDirs[3].'\\vendor\\mgilet\\notification-bundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\TransportBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\activiteBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\RecBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\rappelBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\mailBundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\LoisirsBundle\\Entity')]);

        $b->addDriver($c, 'PioneerBundle\\Entity');
        $b->addDriver($c, 'Mgilet\\NotificationBundle\\Entity');
        $b->addDriver($c, 'TransportBundle\\Entity');
        $b->addDriver($c, 'activiteBundle\\Entity');
        $b->addDriver($c, 'RecBundle\\Entity');
        $b->addDriver($c, 'rappelBundle\\Entity');
        $b->addDriver($c, 'mailBundle\\Entity');
        $b->addDriver($c, 'LoisirsBundle\\Entity');
        ...
        $a->setEntityNamespaces(['PioneerBundle' => 'PioneerBundle\\Entity', 'MgiletNotificationBundle' => 'Mgilet\\NotificationBundle\\Entity', 'TransportBundle' => 'TransportBundle\\Entity', 'activiteBundle' => 'activiteBundle\\Entity', 'RecBundle' => 'RecBundle\\Entity', 'rappelBundle' => 'rappelBundle\\Entity', 'mailBundle' => 'mailBundle\\Entity', 'LoisirsBundle' => 'LoisirsBundle\\Entity']);
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_816f21b1a9376222fcb53636de018a18372fd8a4e7362b9949d6ce672e8c262d');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8WKiAT8SZk', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YE1PwU26-3', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IyHS7SjMlo', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'\\src\\PioneerBundle/Resources/views'), 'Pioneer');
        $instance->addPath(($this->targetDirs[3].'\\src\\PioneerBundle/Resources/views'), '!Pioneer');
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\mgilet\\notification-bundle/Resources/views'), '!MgiletNotification');
        $instance->addPath(($this->targetDirs[3].'\\src\\TransportBundle/Resources/views'), 'Transport');
        $instance->addPath(($this->targetDirs[3].'\\src\\TransportBundle/Resources/views'), '!Transport');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\activiteBundle/Resources/views'), '!activite');
        $instance->addPath(($this->targetDirs[3].'\\src\\RecBundle/Resources/views'), 'Rec');
        $instance->addPath(($this->targetDirs[3].'\\src\\RecBundle/Resources/views'), '!Rec');
        $instance->addPath(($this->targetDirs[3].'\\src\\rappelBundle/Resources/views'), 'rappel');
        $instance->addPath(($this->targetDirs[3].'\\src\\rappelBundle/Resources/views'), '!rappel');
        $instance->addPath(($this->targetDirs[3].'\\src\\mailBundle/Resources/views'), 'mail');
        $instance->addPath(($this->targetDirs[3].'\\src\\mailBundle/Resources/views'), '!mail');
        $instance->addPath(($this->targetDirs[3].'\\src\\LoisirsBundle/Resources/views'), 'Loisirs');
        $instance->addPath(($this->targetDirs[3].'\\src\\LoisirsBundle/Resources/views'), '!Loisirs');
    ...
    private $loadedDynamicParameters = [
        ...
        'livre_directory' => false,
        'fichiers_directory' => false,
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'PioneerBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PioneerBundle'),
                ...
                'TransportBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\TransportBundle'),
                ...
                'RecBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\RecBundle'),
                    'namespace' => 'RecBundle',
                ],
                'KnpSnappyBundle' => [
                    'parent' => NULL,
                    'path' => 'D:/programs/wamp64/www/Web2.0/INT/PioneersWeb/vendor/knplabs/knp-snappy-bundle',
                ...
                'rappelBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\rappelBundle'),
                    'namespace' => 'rappelBundle',
                ],
                'mailBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\mailBundle'),
                    'namespace' => 'mailBundle',
                ],
                'LoisirsBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\LoisirsBundle'),
            ...
            case 'photos_directory': $value = ($this->targetDirs[3].'\\app/../web/uploads/post'); break;
            case 'brochures_directory': $value = ($this->targetDirs[3].'/web/uploads/brochures'); break;
            case 'livre_directory': $value = ($this->targetDirs[3].'/web/web/livres'); break;
            case 'fichiers_directory': $value = ($this->targetDirs[3].'/web/audio/sound'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'rappelBundle' => 'rappelBundle\\rappelBundle',
                'mailBundle' => 'mailBundle\\mailBundle',
                'LoisirsBundle' => 'LoisirsBundle\\LoisirsBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'pionnersapp',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.google.com',
            'mailer_user' => 'fadhel.shel@gmail.com',
            'mailer_password' => 'alfadhel321',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'fadhel.shel@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'alfadhel321',
            ...
            'fos_user.model.user.class' => 'PioneerBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => [
                'mohamedfadhel.shel@esprit.tn' => 'Fadhel',
            ],
