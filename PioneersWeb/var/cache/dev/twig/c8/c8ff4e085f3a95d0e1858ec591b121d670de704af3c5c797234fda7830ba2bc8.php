...
class __TwigTemplate_441e711e550ee7055be3e61e94a5816b3d8be837ddb01ba45d83417f578f1c56 extends \Twig\Template
{
...
";
    ...
    ";
            ...
            <a class=\"page-link\" rel=\"prev\" href=\"";
                ...
                echo "\">&laquo;&nbsp;";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Previous", [], "KnpPaginatorBundle"), "html", null, true);
                echo "</a>
        </li>
    ";
            } else {
...
($context["startPage"] ?? $this->getContext($context, "startPage")) != 2)) {
    ...
    ";
            ...
            <a class=\"page-link\" rel=\"next\" href=\"";
                ...
                echo "\">";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Next", [], "KnpPaginatorBundle"), "html", null, true);
                echo "&nbsp;&raquo;</a>
        </li>
    ";
            } else {
...
{% if pageCount > 1 %}
    ...
    {% if previous is defined %}
        <li class=\"page-item\">
            <a class=\"page-link\" rel=\"prev\" href=\"{{ path(route, query|merge({(pageParameterName): previous})) }}\">&laquo;&nbsp;{{ 'Previous'|trans([], 'KnpPaginatorBundle') }}</a>
        </li>
    {% else %}
        <li class=\"disabled page-item\">
            <a class=\"page-link\">&laquo;&nbsp;{{ 'Previous'|trans([], 'KnpPaginatorBundle') }}</a>
        </li>
    {% endif %}
    ...
    {% if next is defined %}
        <li class=\"page-item\">
            <a class=\"page-link\" rel=\"next\" href=\"{{ path(route, query|merge({(pageParameterName): next})) }}\">{{ 'Next'|trans([], 'KnpPaginatorBundle') }}&nbsp;&raquo;</a>
        </li>
    {% else %}
        <li class=\"disabled page-item\">
            <a class=\"page-link\">{{ 'Next'|trans([], 'KnpPaginatorBundle') }}&nbsp;&raquo;</a>
        </li>
    {% endif %}
    </ul>
{% endif %}
", "@KnpPaginator/Pagination/twitter_bootstrap_v3_pagination.html.twig", "D:\\programs\\wamp64\\www\\Web2.0\\INT\\PioneersWeb\\vendor\\knplabs\\knp-paginator-bundle\\Resources\\views\\Pagination\\twitter_bootstrap_v3_pagination.html.twig");
    }
}
