...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\PioneerBundle\\Entity'), 1 => ($this->targetDirs[3].'\\vendor\\mgilet\\notification-bundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\TransportBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\activiteBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\RecBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\rappelBundle\\Entity'), 6 => ($this->targetDirs[3].'\\src\\mailBundle\\Entity')]);
        ...
        $a->setEntityNamespaces(['PioneerBundle' => 'PioneerBundle\\Entity', 'MgiletNotificationBundle' => 'Mgilet\\NotificationBundle\\Entity', 'TransportBundle' => 'TransportBundle\\Entity', 'activiteBundle' => 'activiteBundle\\Entity', 'RecBundle' => 'RecBundle\\Entity', 'rappelBundle' => 'rappelBundle\\Entity', 'mailBundle' => 'mailBundle\\Entity']);
